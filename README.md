...
按输入粒度看，line `470` 条 Avg NED `0.025444`，region `119` 条 Avg NED `0.082315`，page `169` 条 Avg NED `0.186774`。这说明 LoRA 已把通用 OCR 从“不适配规范彝文”推进到可用于真实彝文资料整理的 OCR 模型；同时，整页图、屏幕拍照和手写拍照仍是需要页面切割与人工复核的主要难点。
