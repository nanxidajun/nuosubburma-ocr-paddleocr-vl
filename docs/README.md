...
文档按 PaddleOCR 全球衍生模型挑战赛的评分项组织。评审若只看一份文件，建议先看 [COMPETITION_SUBMISSION.md](COMPETITION_SUBMISSION.md)；若要核验证据，再按官方六个维度进入专题文档。
...
| 任务复杂度 | [页面处理说明](PAGE_PROCESSING.md) | 整页、PDF、页面照片的页面切割、阅读顺序和文本区域识别能力 |
