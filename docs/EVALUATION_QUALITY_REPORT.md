...
| 数据多样性 | 覆盖新印刷、旧印刷、手写拍照、场景照片、屏幕拍照，以及纯彝文、混排、数字、页码、脚注、整页和多行区域。 |
...
按数据集维度拆分，line `470` 条 Avg NED `0.025444`，region `119` 条 Avg NED `0.082315`，page `169` 条 Avg NED `0.105898`；旧印刷 `507` 条 Avg NED `0.034428`，屏幕拍照/页面上传图 `87` 条 Avg NED `0.117566`，手写拍照 `53` 条 Avg NED `0.122555`。
