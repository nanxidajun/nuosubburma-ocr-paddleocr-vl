...
本目录保存 `规范彝文 OCR / NuosuBburma OCR` 在提交评估集上的公开评估结果。
...
| ASCII-letter | 预测是否输出拉丁字母 | 本次为 `18` 条；这 18 条 GT 本身也都有 Latin 注音，不计作多余拉丁漂移 |
| extra Latin | GT 无 Latin 但预测多出 Latin | 越少越好，本次为 `0` 条 |
...
结论：新旧印刷体表现稳定，手写仍是最弱场景；照片/真实场景样本量较小，只作为补充观察。
